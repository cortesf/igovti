...
<html lang="pt-br">
    ...
    <body>
        ...
        <form action="radio.php" method="POST" id='formulario' class='form'>
            ...
            <br><br>
            <B>11-D; A organização dispõe de um código de ética, formalmente instituído, bem como divulga e monitora o seu cumprimento.</B><br>
            ...
            <B>11-E; A organização dispõe de uma política corporativa de gestão de riscos formalmente instituída, como norma de cumprimento obrigatório.</B><br>
            ...
            <br><br>
            <B>12-A; A organização define e comunica formalmente papéis e responsabilidades mais relevantes para a governança e gestão de TI.</B><br>
            ...
            <br><br>
            <B>12-C; O comitê de TI realiza as atividades previstas em seu ato constitutivo.</B><br>
            ...
            <br><br>
            <B>13-A; A organização define formalmente diretrizes para o planejamento de TI.</B><br>
            ...
            <br><br>
            <B>13-B; A organização define formalmente diretrizes para gestão do portfólio de projetos e serviços de TI, inclusive para definição de critérios de priorização e de alocação orçamentária.</B><br>
            ...
            <br><br>
            <B>13-D; A organização define formalmente diretrizes para avaliação do desempenho dos serviços de TI.</B><br>
            ...
            <br><br>
            <B>14-B; A organização define e comunica formalmente papéis e responsabilidades pela gestão de riscos de TI.</B><br>
            ...
            <br><br>
            <B>15-B; A organização define formalmente diretrizes para garantir o desenvolvimento de competências e a retenção de pessoal técnico de TI.</B><br>
            ...
            <br><br>
            <B>15-C; A organização define formalmente diretrizes para avaliação e incentivo ao desempenho de gestores de TI.</B><br>
            ...
            <br><br>
            <B>15-E; A organização define formalmente diretrizes para escolha dos líderes da área de TI, ocupantes dos cargos de chefia e de assessoramento.</B><br>
            ...
            <B>17-A; A organização define formalmente diretrizes para avaliação da governança e da gestão de TI.</B><br>
            ...
            <br><br>
            <B>17-C; A organização realiza avaliação periódica de sistemas de informação.</B><br>
            ...
            <br><br>
            <B>17-E; A organização realiza avaliação periódica de contratos de TI.</B><br>
            ...
            <br><br>
            <B>21-C; O processo de planejamento estratégico institucional prevê a participação da área de TI</B><br>
            ...
            <br><br>
            <B>21-E; A organização possui plano estratégico institucional vigente, formalmente instituído pelo seu dirigente máximo.</B><br>
            ...
            <br><br>
            <B>21-H; O plano estratégico institucional vigente estabelece os projetos e ações considerados necessários e suficientes para o alcance das metas fixadas.</B><br>
            ...
            <br><br>
            <B>21-I; A execução do plano estratégico institucional vigente é acompanhada periodicamente quanto ao alcance das metas estabelecidas, para correção de desvios.</B><br>
            ...
            <br><br>
            <B>22-B; O processo de planejamento de TI prevê a participação das áreas mais relevantes da organização.</B><br>
            ...
            <br><br>
            <B>22-C; O processo de planejamento de TI prevê o apoio do comitê de TI.</B><br>
            ...
            <br><br>
            <B>22-D; O processo de planejamento de TI está formalmente instituído, como norma de cumprimento obrigatório.</B><br>
            ...
            <B>22-F; O plano de TI vigente contempla objetivos, indicadores e metas para a TI, com os objetivos explicitamente alinhados aos objetivos de negócio constantes do plano estratégico institucional.</B><br>
            ...
            <br><br>
            <B>22-G; O plano de TI vigente contém alocação de recursos (orçamentários, humanos e materiais) e estratégia de execução indireta (terceirização).</B><br>
            ...
            <br><br>
            <B>22-H; A execução do plano de TI vigente é acompanhada periodicamente quanto ao alcance das metas estabelecidas, para correção de desvios.</B><br>
            ...
            <br><br>
            <B>22-J; O plano de TI vigente fundamenta a proposta orçamentária de TI.</B><br>
            ...
            <br><br>
            <B>31-A; A organização identifica e mapeia os principais processos de negócio.</B><br>
            ...
            <br><br>
            <B>31-B; Os principais processos de negócio da organização são suportados por sistemas informatizados.</B><br>
            ...
            <br><br>
            <B>31-C; Há catálogo publicado com informações atualizadas de cada um dos sistemas informatizados.</B><br>
            ...
            <br><br>
            <B>31-D; A organização designa formalmente responsáveis da área de negócio para a gestão dos respectivos sistemas informatizados.</B><br>
            ...
            <br><br>
            <B>32-A; Os planos de TI vigentes são divulgados na internet, sendo facilmente acessados.</B><br>
            ...
            <br><br>
            <B>32-C; As informações sobre o acompanhamento das ações e dos projetos de TI são divulgadas na internet, sendo facilmente acessadas.</B><br>
            ...
            <B>32-D; Os editais, seus respectivos anexos e os resultados das licitações de TI (inteiro teor) são divulgados na internet, sendo facilmente acessados.</B><br>
            ...
            <br><br>
            <B>32-E; Os estudos técnicos preliminares (inteiro teor) são divulgados na internet, juntamente com os editais de licitação de TI, sendo facilmente acessados.</B><br>
            ...
            <br><br>
            <B>32-G; A execução orçamentária de TI, ao longo do exercício, é divulgada na internet, sendo facilmente acessada.</B><br>
            ...
            <br><br>
            <B>41-B; A organização define critérios para avaliação e atendimento dos pedidos de capacitação.</B><br>
            ...
            <br><br>
            <B>41-C; A organização elabora, periodicamente, plano de capacitação para suprir as necessidades de desenvolvimento de competências de TI.</B><br>
            ...
            <br><br>
            <B>41-D; A organização acompanha a execução do plano de capacitação, com identificação e correção de desvios.</B><br>
            ...
            <br><br>
            <B>41-F; O plano de capacitação inclui o desenvolvimento de competências em gestão de TI.</B><br>
            ...
            <br><br>
            <B>42-A; A organização estabelece metas de desempenho para o pessoal de TI.</B><br>
            ...
            <br><br>
            <B>42-B; A organização avalia periodicamente o desempenho do pessoal de TI.</B><br>
            ...
            <br><br>
            <B>42-C; A organização estabelece benefício, financeiro ou não se aplica, em função do desempenho alcançado pelo pessoal de TI.</B><br>
            ...
            <B>43-B1; O quantitativo considerado de remuneração ideal foi estimado com base em estudo técnico de avaliação quantitativa e qualitativa do quadro de pessoal da área de TI.</B><br>
            ...
            <br><br>
            <B>51-M; A organização executa processo de gerenciamento de problemas.</B><br>
            ...
            <br><br>
            <B>52-F; A área de TI comunica periodicamente o resultado desse monitoramento às áreas clientes.</B><br>
            ...
            <br><br>
            <B>53-C; A organização trata os riscos de TI dos processos críticos de negócio com base em um plano de tratamento de risco.</B><br>
            ...
            <br><br>
            <B>54-C; A organização possui gestor de segurança da informação formalmente designado, responsável pelas ações corporativas de segurança da informação.</B><br>
            ...
            <br><br>
            <B>54-P; O processo de monitoramento do uso dos recursos de TI está formalmente instituído, como norma de cumprimento obrigatório.</B><br>
            ...
            <br><br>
            <B>55-A; A organização executa um processo de software, com o objetivo de assegurar que o software a ser desenvolvido, direta ou indiretamente, atenda às suas necessidades.</B><br>
            ...
            <br><br>
            <B>55-B; O processo de software é acompanhado por meio de mensurações, com indicadores quantitativos e metas de processo a cumprir.</B><br>
            ...
            <br><br>
            <B>56-B; A organização executa processo de gerenciamento de projetos de TI.</B><br>
            ...
            <br><br>
            <B>57-D; A organização explicita, nos autos, o alinhamento entre a contratação e os planos estratégico institucional e de TI vigentes.</B><br>
            ...
            <B>57-E; A organização realiza análise dos riscos que possam comprometer o sucesso do processo de contratação e dos resultados que atendam às necessidades de negócio.</B><br>
            ...
            <br><br>
            <B>57-I; A organização diferencia e define formalmente os papéis de gestor e fiscal do contrato.</B><br>
            ...
            <br><br>
            <B>58-D; O processo de planejamento das contratações de TI é periodicamente revisado e melhorado com base nas mensurações obtidas.</B><br>
            ...
            <br><br>
            <B>59-B; A organização executa processo de gestão de contratos de TI.</B><br>
            ...
            <br><br>
            <B>59-E; O processo de gestão de contratos de TI está formalmente instituído, como norma de cumprimento obrigatório.</B><br>
            ...
            <br><br>
            <B>62-A; A organização possui projetos de TI com mais de dois anos de início e que estão em andamento.</B><br>
            ...
            <br><br>
            <B>64-C; Os serviços acessíveis via internet implementam as diretrizes e as especificações dos Padrões de Interoperabilidade de Governo Eletrônico – ePING, previsto no Programa de Governo Eletrônico Brasileiro.</B><br>
            ...
            <br><br>
            <B>64-E; Há catálogo publicado com informações claras e precisas de cada um dos serviços acessíveis via internet.</B><br>
            ...
            <br><br>
            <B>64-G; Os resultados das avaliações dos serviços acessíveis via internet são divulgados ao cidadão/cliente.</B><br>
