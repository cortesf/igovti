...
$texto =  "<html><body style = 'color:#373636;
                ...
                margin: 0 0 40px;'><p> <b>O seu índice de governança será: $resultado.<b></p> <br>
                Verifique abaixo em qual nível sua organização estará de acordo com o iGovTI Ajustado resultante do modelo preditivo<br> </body></html>";
echo $texto;
...
<html lang="pt-br">
    ...
    <body>
        <br><h2>Nível de Governança de TI </h2>
        <ol>
            <li>Inicial
                0 ≤ iGovTI < 30 </li>
            <li>Básico
