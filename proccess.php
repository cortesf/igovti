...
$universidade = $_POST['instituicao'];
$sigla = $_POST['sigla'];
$estado = $_POST['estado'];
$municipio = $_POST['municipio'];

// Persistindo origem dos dados.
$query = "INSERT INTO origem (universidade, sigla, estado, municipio) VALUES ('".$universidade."','".$sigla."','".$estado."','".$municipio."')";
...
foreach ($_POST['pergunta'] as $p => $v) {
  //printf ("%s => %s<br />", $p, $v);
  $query = "INSERT INTO resposta (id_origem, cod_pergunta, resposta) VALUES ('".$lastid."','".$p."','".$v."')";
